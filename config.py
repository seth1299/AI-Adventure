...
2. INVENTORY MANAGEMENT:
   ...
   - IMPORTANT: When the Player gains or loses wealth/currency, INSTEAD OF USING [[ADD]], PLEASE OUTPUT [[CHANGE_CURRENCY: X]] instead, with X representing the raw number of Base Units the Player gained/lost in that turn. For example, if a Silver Piece is worth 10 Copper Pieces, and the Player found 1 Silver and 5 Copper pieces, then you would output the tag [[CHANGE_CURRENCY 15]], since logically, that would be 15 Copper Pieces altogether.
